...
//				return this.VocabFile_lineCount;
		...
		public void set_vocabulary( Dictionary<string, int> in_vocabwords = null )
		{
...
//				vocabwords = System.IO.File.ReadAllLines (@"VocabFile.txt");
				...
				vocabwords = new Dictionary<string, int>();
				foreach(var vocab_word in list){
					int value = 0;
					vocabwords.Add(vocab_word, value);
				} 
...
//			vocabwords = System.IO.File.ReadAllLines(@"VocabFile.txt");
		...
		// словарь
		private Dictionary<string, int> vocabwords;
	}
